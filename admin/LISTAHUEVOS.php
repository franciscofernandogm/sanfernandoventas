...
try {
    ...
    $stmt = $conn->prepare("SELECT producto_codigo FROM productos WHERE producto_codigo IN ('P56')");
    $stmt->execute();
$pc=array();
$i=0;
...
<head>
    <meta charset="utf-8">
    <title>Huevos | Administrador</title>
...
<body style="background-image: url('https://media-exp1.licdn.com/dms/image/C561BAQFW0VeGebvBVw/company-background_10000/0?e=2159024400&v=beta&t=1g_Ngy8kVKQZVGXAUY80GqlD7MpbcPAC6baPRixEu3Y');">
    ...
    <h1 style="background-color: rgb(114, 157, 244 ,0.4);">LISTADO DE HUEVO</h1>
    <br>
    <br>
...
<table style='width: 70%;margin:0 auto;border: none;background: none'>
  ...
  <tr>
    ...
    <?php
        ...
        $solicitud="SELECT * FROM productos WHERE producto_codigo IN ('P56')";
        ...
        $huevo = array('https://dojiw2m9tvv09.cloudfront.net/38342/product/M_huevos22505.jpg?75');
        $i=0;
        while($fila=mysqli_fetch_array($resultado)){
            echo "<tr>";
            echo "<td>".$fila['producto_codigo']."</td>";
            echo "<td> <img id='imagen' src='".$huevo["$i"]."'></td>";
