...
try {
    ...
    $stmt = $conn->prepare("SELECT producto_codigo FROM productos WHERE producto_codigo IN ('P01','P02','P03','P04','P05','P06','P07','P08','P09','P10','P11','P12','P13')");
    $stmt->execute();
$pc=array();
$i=0;
...
<head>
    <meta charset="utf-8">
    <title>Pollos | Administrador</title>
...
<body style="background-image: url('https://media-exp1.licdn.com/dms/image/C561BAQFW0VeGebvBVw/company-background_10000/0?e=2159024400&v=beta&t=1g_Ngy8kVKQZVGXAUY80GqlD7MpbcPAC6baPRixEu3Y');">
    ...
    <h1 style="background-color: rgb(114, 157, 244 ,0.4);">LISTA DE POLLOS</h1>
    <br>
    <br>
...
<table style='width: 70%;margin:0 auto;border: none;background: none'>
  ...
  <tr>
    ...
    <?php
        ...
        $solicitud="SELECT * FROM productos WHERE producto_codigo IN ('P01','P02','P03','P04','P05','P06','P07','P08','P09','P10','P11','P12','P13')";
        ...
        while($fila=mysqli_fetch_array($resultado)){
            ...
            echo "<td> <img id='imagen' src='".$pollo["$i"]."'></td>";
